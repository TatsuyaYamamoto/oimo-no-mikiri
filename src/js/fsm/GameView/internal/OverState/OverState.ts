...
abstract class OverState extends AbstractGameState {
    ...
    onEnter(params: EnterParams): void {
        ...
        const winnerName = new WinnerName(winner === Actor.PLAYER ? this.player.name : this.opponent.name);
        winnerName.position.set(0, paperHeight * 0.05);

        const playerSprite = winner === Actor.PLAYER ?
        ...
        const opponentSprite = winner === Actor.PLAYER ?
